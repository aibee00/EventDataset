...
sys.path.insert(0, 'dataset/grit_src/third_party/CenterNet2/projects/CenterNet2/')

# from centernet.config import add_centernet_config
from dataset.grit_src.grit.config import add_grit_config

from dataset.grit_src.grit.predictor import VisualizationDemo
import json
...
def get_parser(device):
    arg_dict = {'config_file': "dataset/grit_src/configs/GRiT_B_DenseCap_ObjectDet.yaml", 'cpu': False, 'confidence_threshold': 0.5, 'test_task': 'DenseCap', 'opts': ["MODEL.WEIGHTS", "pretrained_models/grit_b_densecap_objectdet.pth"]}
    if device == "cpu":
        arg_dict["cpu"] = True
    return arg_dict
